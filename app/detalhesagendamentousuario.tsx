      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <Image
            ...
            style={[
              styles.avatar,
              { backgroundColor: '#E9E9E9', borderColor: '#E5E5E5', borderWidth: 1 },
            ]}
            onError={() =>
              setAvatarSrc({ uri: 'https://i.pravatar.cc/150?u=point-tils-fallback' })
            }
          />
          ...
          {isAgendamento ? (
            ...
            <View style={styles.section}>
              ...
              <View style={styles.rowBetween}>
                ...
                >
                  <Text style={[styles.whatsText, { color: colors.primaryBlue }]}>
                    {lbl.whatsapp}
                  </Text>
                </Pressable>
              </View>
...
const styles = StyleSheet.create({
  ...
  ocupacao: {
    marginTop: 2,
    marginBottom: 6,           // dá um respiro antes das estrelas
    fontSize: 14,
    fontFamily: 'iFoodRC-Medium', // negrito
  },
  ratingRow: {
    marginTop: 4, // espaço extra entre ocupação e estrelas
  },
