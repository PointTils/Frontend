...
export const config = {
  light: vars({
    ...
    '--color-primary-500': hexToRgb(Colors.light.primaryOrange),
    ...
    '--color-typography-900': hexToRgb(Colors.light.text),
    ...
    /* Background */
    '--color-background-0': hexToRgb(Colors.light.background),
  ...
  dark: vars({
    ...
    '--color-primary-500': hexToRgb(Colors.dark.primaryOrange),
    ...
    '--color-typography-900': hexToRgb(Colors.dark.text),
    ...
    /* Background */
    '--color-background-0': hexToRgb(Colors.dark.background),
